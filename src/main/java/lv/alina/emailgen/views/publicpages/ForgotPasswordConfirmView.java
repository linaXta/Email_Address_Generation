...
public class ForgotPasswordConfirmView extends VerticalLayout implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        this.email = event.getLocation().getQueryParameters()
                .getParameters()
        ...
        if (email.isBlank()) {
            event.forwardTo("forgot-password");
            return;
        }
    ...
    private void buildLayout() {
        ...
        backButton.addClickListener(event -> getUI().ifPresent(ui -> ui.navigate("forgot-password")));
        ...
        H2 title = new H2("Confirm and create new Password!");
        ...
        updateButton.addClassName("auth-primary-btn");
        updateButton.addClickListener(event -> handleUpdatePassword());
    ...
    private void handleUpdatePassword() {
        ...
        if (email == null || email.isBlank()) {
            showError("E-mail is missing. Please return to forgot password page.");
            return;
        }
